...
documentedStoriesOf('base|collapse', readme)
  .add('default', () => ({
    ...
    template: `
      <div>
        ...
        <gl-button v-gl-collapse-toggle.collapse-with-heading class="float-right" variant="primary">
          Toggle Collapse
        </gl-button>
  ...
  .add('initially expanded', () => ({
    ...
    template: `
      <div>
        <gl-button v-gl-collapse-toggle.collapse-template variant="primary">Toggle Collapse</gl-button>
