    ...
    data() {
      return generateData({
        option: {
          toolbox: {
            feature: {
              // The reason options were used instead of the mixin props
              // is because of a bug, were even when using the mixin props
              // the component wouldn't register the values
              dataZoom: {
                icon: {
                  zoom:
